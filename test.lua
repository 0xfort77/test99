        ...
        while auto_SH_flag do
            ...
            if stronghold_loc:FindFirstChild("Stronghold") then
                ...
                if internal_time == "00s" then
                    ...
                    if not workspace.Map.Landmarks.Stronghold.Functional.FinalGate.Main.CFrame.Position == (683.0052490234375, 63.488651275634766, 37.91798400878906) then
                        local done_sh = false
